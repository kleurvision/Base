...
--
-- Host: localhost
-- Generation Time: Aug 13, 2013 at 05:57 AM
...
INSERT INTO `app_hero` (`id`, `herotitle`, `herocontent`, `heroimg`) VALUES
...
CREATE TABLE `app_options` (
  ...
  `app_theme` varchar(100) DEFAULT NULL,
...
INSERT INTO `app_options` (`id`, `layout`, `app_url`, `site_name`, `app_name`, `app_theme`, `footer_stick`, `pagetitle`, `pagemeta_desc`, `pagemeta_keywords`, `app_analytics`, `app_users`, `activation_date`) VALUES
...
(2, 'fluid', 'http://www.clickityclank.com', NULL, 'Clickity Clank Test', 'default', 'true', 'Test account for Clickity Clank', '', '', NULL, NULL, NULL);
...
INSERT INTO `app_pages` (`id`, `pagename`, `pagetitle`, `pagecontent`, `pageauthor`, `pagemeta_title`, `pagemeta_desc`, `pagemeta_keywords`, `pagetemplate`, `pageparent`, `pagedate`, `pagepriority`, `pagechangefreq`) VALUES
...
(1, 'concierge', 'concierge@kleurvision.com', '2f8f0af94850c0cf3eda398a09a3ab3c', 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
