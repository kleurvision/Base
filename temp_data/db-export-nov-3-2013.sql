...
--
-- Host: localhost
-- Generation Time: Nov 03, 2013 at 04:15 AM
...
--
-- Table structure for table `app_partners`
--
...
--
-- Dumping data for table `app_partners`
--

INSERT INTO `app_partners` (`id`, `username`, `businessname`, `created`, `modified`, `email`, `password`, `fname`, `lname`, `phone`, `addr1`, `addr2`, `postal`, `city`, `province`, `country`, `mobile`, `url`) VALUES
(1, '', 'DT Media', NULL, NULL, 'support@dtmedia.ca', '7465520975d6323c067f1bdd434e341a', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '', 'Kleurvision', NULL, NULL, 'patrick@kleurvision.com', '7465520975d6323c067f1bdd434e341a', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'http://webninja.me/', 'webninja', 'webninja', 'webninja', NULL, NULL, 2),
(2, 'http://sproutdrop.com/', 'sproutdrop', 'Sprout Drop', 'default', NULL, NULL, 2),
(20, 'http://oshawawebdesigner.com/', 'oshawa_web_designer', 'Oshawa Web Designer', 'base-theme', NULL, '2013-08-28', 4),
(21, 'http://nottinghilllandscaping.com/', 'nottinghill_landscaping', 'Nottinghill Landscaping', 'rosedale', NULL, '2013-09-02', 1),
(22, 'http://fitmotto.com/', 'fit_motto', 'Fit Motto', 'cabbagetown', 8, '2013-09-02', 4),
(23, 'http://sdplumbing.org/', 'durham_plumbing_services', 'Durham Plumbing Services', 'rosedale', NULL, '2013-10-18', 1),
(24, 'http://eandajanitorial.ca/', 'ea_janitorial', 'E & A Janitorial', 'rosedale', NULL, '2013-10-19', 1);
...
INSERT INTO `app_users` (`id`, `username`, `email`, `password`, `role`, `bio`, `phone`, `addr1`, `addr2`, `postal`, `city`, `province`, `country`, `mobile`, `url`, `fname`, `lname`, `title`, `salutation`, `facebook`, `partner_id`) VALUES
(1, NULL, 'concierge@kleurvision.com', '2f8f0af94850c0cf3eda398a09a3ab3c', 10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2),
(2, NULL, 'briancaicco@gmail.com', '7465520975d6323c067f1bdd434e341a', 10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Brian', 'Caicco', NULL, NULL, NULL, 1),
(8, NULL, 'fitmotto@gmail.com', '3d801aa532c1cec3ee82d87a99fdf63f', 1, '', NULL, '', '', '', '', '', '', '', NULL, 'Brandon', 'Cooper', NULL, NULL, NULL, NULL);
...
(50, 2, 'afb27cd9c76f6f87a77e298c0e7b364d', 0, '131019224145', '131019232422'),
(51, 2, 'd5a229d879bdb32df84421edf6c9fb82', 0, '131019232429', '131019232452'),
(52, 2, '46bd036534dd7cc47752f81d1d91e83c', 0, '131019232509', NULL),
(53, 2, '639e0a30cf472499a22f1d99286bb912', 0, '131020130335', NULL),
(54, 2, '152b0c716dbaa213512f8f833f5097d7', 0, '131020202331', NULL),
(55, 2, '052d486e9cbc57c5ca84b83d3aa7173f', 0, '131021023840', NULL),
(56, 2, '4363c866c3a415eb4c6ab9fd7d2e9361', 0, '131021175933', NULL),
(57, 2, '796a4114a1426a1edd8e51ed7a5f736b', 0, '131022114821', '131022114949'),
(58, 2, '212d35180556c9cdd3d1b21151d2ed73', 0, '131024145023', NULL),
(59, 1, '900dfebdbf02c56c6f0d30879ee154b8', 0, '131024191618', NULL),
(60, 2, 'a4a50a5c58c3149140f99f066f91502d', 0, '131103040802', NULL);
...
(1, 'about', 'About', '<p>Nottinghill Landscaping is dedicated to providing pristine and meticulous property care . Attention to detail, skill and knowledge are among the most important values that set Nottinghill apart from other companies. Our specialization lies in the lawn. Excellent lawn maintenance has always remained our strongest attribute. With a committed focus on the health and well being of the properties we care for, satisfaction is guaranteed. For years, homes, commercial properties and estates in Oakville, Burlington and Milton have experienced our unmatched service and quality of care. Allow us to provide you with the same treatment</p>\r\n', 0, '', '', '', '', NULL, NULL, NULL, NULL),
...
--
-- Dumping data for table `site_24_pages`
--

INSERT INTO `site_24_pages` (`id`, `pagename`, `pagetitle`, `pagecontent`, `pageauthor`, `pagemeta_title`, `pagemeta_desc`, `pagemeta_keywords`, `pagetemplate`, `pageparent`, `pagedate`, `pagepriority`, `pagechangefreq`) VALUES
(1, 'about', 'About', '<p>We offer office cleaning, floor treatment, carpet cleaning, window cleaning and maintenance for businesses with office space in the Durham Region and GTA areas.</p>\r\n\r\n<p>The business was founded by partners, Evelyn Leonard and Allen Cole, cleaning industry professionals with years of collective experience, who have put their resources together to develop a new strategy for reaching and serving business clients.&nbsp;</p>\r\n', NULL, '', '', '', '', NULL, NULL, NULL, NULL);
...
--
-- Dumping data for table `site_24_settings`
--

INSERT INTO `site_24_settings` (`id`, `navigation`) VALUES
(24, '[{"id":1}]');

-- --------------------------------------------------------

--
-- Table structure for table `site_25_hero`
--

DROP TABLE IF EXISTS `site_25_hero`;
CREATE TABLE IF NOT EXISTS `site_25_hero` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `herotitle` longtext,
  `herocontent` longtext,
  `heroimg` longtext,
...
--
-- Table structure for table `site_25_pages`
--

DROP TABLE IF EXISTS `site_25_pages`;
CREATE TABLE IF NOT EXISTS `site_25_pages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pagename` varchar(50) DEFAULT NULL,
  `pagetitle` varchar(100) DEFAULT NULL,
  `pagecontent` longtext,
...
--
-- Table structure for table `site_25_settings`
--

DROP TABLE IF EXISTS `site_25_settings`;
CREATE TABLE IF NOT EXISTS `site_25_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `navigation` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `site_26_hero`
--

DROP TABLE IF EXISTS `site_26_hero`;
CREATE TABLE IF NOT EXISTS `site_26_hero` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `herotitle` longtext,
  `herocontent` longtext,
  `heroimg` longtext,
...
--
-- Table structure for table `site_26_pages`
--

DROP TABLE IF EXISTS `site_26_pages`;
CREATE TABLE IF NOT EXISTS `site_26_pages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pagename` varchar(50) DEFAULT NULL,
  `pagetitle` varchar(100) DEFAULT NULL,
  `pagecontent` longtext,
...
--
-- Table structure for table `site_26_settings`
--

DROP TABLE IF EXISTS `site_26_settings`;
CREATE TABLE IF NOT EXISTS `site_26_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `navigation` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `site_27_hero`
--

DROP TABLE IF EXISTS `site_27_hero`;
CREATE TABLE IF NOT EXISTS `site_27_hero` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `herotitle` longtext,
  `herocontent` longtext,
  `heroimg` longtext,
...
--
-- Table structure for table `site_27_pages`
--

DROP TABLE IF EXISTS `site_27_pages`;
CREATE TABLE IF NOT EXISTS `site_27_pages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pagename` varchar(50) DEFAULT NULL,
  `pagetitle` varchar(100) DEFAULT NULL,
  `pagecontent` longtext,
...
--
-- Table structure for table `site_27_settings`
--

DROP TABLE IF EXISTS `site_27_settings`;
CREATE TABLE IF NOT EXISTS `site_27_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `navigation` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `site_28_hero`
--

DROP TABLE IF EXISTS `site_28_hero`;
CREATE TABLE IF NOT EXISTS `site_28_hero` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `herotitle` longtext,
  `herocontent` longtext,
  `heroimg` longtext,
...
--
-- Table structure for table `site_28_pages`
--

DROP TABLE IF EXISTS `site_28_pages`;
CREATE TABLE IF NOT EXISTS `site_28_pages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pagename` varchar(50) DEFAULT NULL,
  `pagetitle` varchar(100) DEFAULT NULL,
  `pagecontent` longtext,
...
--
-- Table structure for table `site_28_settings`
--

DROP TABLE IF EXISTS `site_28_settings`;
CREATE TABLE IF NOT EXISTS `site_28_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `navigation` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `site_29_hero`
--

DROP TABLE IF EXISTS `site_29_hero`;
CREATE TABLE IF NOT EXISTS `site_29_hero` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `herotitle` longtext,
  `herocontent` longtext,
  `heroimg` longtext,
...
--
-- Table structure for table `site_29_pages`
--

DROP TABLE IF EXISTS `site_29_pages`;
CREATE TABLE IF NOT EXISTS `site_29_pages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pagename` varchar(50) DEFAULT NULL,
  `pagetitle` varchar(100) DEFAULT NULL,
  `pagecontent` longtext,
...
--
-- Table structure for table `site_29_settings`
--

DROP TABLE IF EXISTS `site_29_settings`;
CREATE TABLE IF NOT EXISTS `site_29_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `navigation` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
